...
export const siteConfig = {
	...
	meta: {
		title: "GL Solutions — Spec Driven Development para Chile y LatAm",
		description:
			"GL Solutions: Spec Driven Development para startups B2B SaaS y Fintech en Chile y LatAm. Software que cualquier ingeniero puede entender desde el día uno.",
		keywords:
			"Spec Driven Development, SDD, consultoría de software, startups Fintech, desarrollo de software Chile, B2B SaaS LatAm",
	...
	social: {
		...
		github: "",
		blog: "https://ricoui.com", // ponytail: keep for now, dead code flagged in verify-report
	},
};
