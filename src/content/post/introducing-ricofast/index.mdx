...
RicoFast aims for the middle: core marketing pages, auth templates, content pages, utility pages, reusable sections you can mix and match, and a token-based design system that is documented well enough to extend with confidence.
...
The template uses Astro v5 Content Layer for blog and changelog content. That gives the site a simple local-content workflow today and a clear path to external content sources later.
